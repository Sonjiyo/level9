...
public class _01날짜와시간 {
	public static void main(String[] args) {
		...
		//두 날짜 사이의 간격을 일 시 분 로 단위로 각각 환산
		...
		//String -> 날짜 객체
		String nowDate = "2023-12-26";
		DateTimeFormatter formatter3 = DateTimeFormatter.ofPattern("yyyy-MM-dd");
		LocalDate time = LocalDate.parse(nowDate, formatter3);
		System.out.println(time);
		
		String nowDate2 = "1234-12-23 18:00:00";
		DateTimeFormatter formatter4 = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");
		LocalDateTime time2 = LocalDateTime.parse(nowDate2, formatter4);
